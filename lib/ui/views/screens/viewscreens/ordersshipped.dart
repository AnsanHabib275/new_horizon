...
class Ordersshipped extends StatefulWidget {
  const Ordersshipped({super.key});

  @override
  State<Ordersshipped> createState() => _OrdersshippedState();
}
...
class _OrdersshippedState extends State<Ordersshipped> {
  ...
  Future<void> loadorders() async {
    try {
      ...
      var pendingOrders = fetchedOrders
          .where((patient) => patient.orderstatus == 'SHIPPED')
          .toList();
      setState(() {
