// ignore_for_file: unnecessary_null_comparison, prefer_const_literals_to_create_immutables, prefer_interpolation_to_compose_strings, avoid_print, deprecated_member_use, duplicate_ignore, non_constant_identifier_names
...
import 'package:new_horizon/ui/views/screens/viewscreens/invoicesunpaid.dart';
import 'package:searchbar_animation/searchbar_animation.dart';
import 'package:shimmer/shimmer.dart';

class InvoicePaid extends StatefulWidget {
  const InvoicePaid({super.key});
  ...
  Future<void> loadorders() async {
    try {
      ...
      var pendingOrders = fetchedOrders
          .where((patient) => patient.invoiceStatus == 'PAID')
          .toList();
      setState(() {
