// ignore_for_file: prefer_interpolation_to_compose_strings, prefer_const_constructors, unnecessary_null_comparison, prefer_const_literals_to_create_immutables, prefer_adjacent_string_concatenation, deprecated_member_use, non_constant_identifier_names
...
import 'package:new_horizon/ui/views/screens/viewscreens/ordersdenied.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/orderspending.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/ordersshipped.dart';
...
class _OrderscompletedState extends State<Orderscompleted> {
  ...
  Future<void> loadorders() async {
    try {
      ...
      var pendingOrders =
          fetchedOrders
              .where((patient) => patient.orderstatus == 'COMPLETED')
              .toList();
      setState(() {
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            fontFamily: 'Segoe UI',
                            fontSize: heights <= 690 && widths <= 430 ? 10 : 14,
                          ),
                        ),
                      ),
                    ),
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          capitalizeFirstLetter(widget.order.orderstatus),
                          style: TextStyle(
                            fontWeight: FontWeight.normal,
                            fontFamily: 'Segoe UI',
                            fontSize: 10,
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          child: Column(
            children: [
              SizedBox(height: heights <= 684 && widths <= 412 ? 0 : 10),
              ticketDetailsRow('Subtotal', '\$' + subtotal.toStringAsFixed(1)),
              SizedBox(height: heights <= 684 && widths <= 412 ? 5 : 10),
              ticketDetailsRow(
                'Discount ' + '-10' + '%',
                '-\$' + discount.toStringAsFixed(1),
              ),
              SizedBox(height: heights <= 684 && widths <= 412 ? 8 : 10),
              Divider(
                color: Color.fromARGB(255, 208, 208, 208),
                height: 1,
                thickness: 1,
  ...
  return Row(
    ...
    children: [
      ...
      Padding(
        ...
        child: Text(desc, style: const TextStyle(color: Colors.black)),
      ),
    ],
  );
}
