// ignore_for_file: unnecessary_null_comparison, prefer_const_literals_to_create_immutables, prefer_interpolation_to_compose_strings, avoid_print, deprecated_member_use, non_constant_identifier_names

import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:get/get.dart';
import 'package:new_horizon/core/constants/asset_constants.dart';
import 'package:new_horizon/core/models/invoicemodel.dart';
import 'package:new_horizon/core/services/apis/user/invoicedetail.dart';
import 'package:new_horizon/ui/utils/colors.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/invoicedetailscreen.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/invoices.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/invoicescompleted.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/invoicesinvoiced.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/invoicespaid.dart';
import 'package:searchbar_animation/searchbar_animation.dart';
import 'package:shimmer/shimmer.dart';

class InvoicesUnpaid extends StatefulWidget {
  const InvoicesUnpaid({super.key});

  @override
  State<InvoicesUnpaid> createState() => _InvoicesUnpaidState();
}
...
class _InvoicesUnpaidState extends State<InvoicesUnpaid> {
  ...
  Future<void> loadorders() async {
    try {
      ...
      var pendingOrders = fetchedOrders
          .where((patient) => patient.invoiceStatus == 'UNPAID')
          .toList();
      setState(() {
              ...
              child: SizedBox(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      width: heights <= 690 && widths <= 430 ? 2 : 6,
                    ),
                    GestureDetector(
                        onTap: () {
                          Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const InvoicePaid()));
                        },
                        child: Padding(
                          padding: const EdgeInsets.only(bottom: 8.0),
                          child: Text(
...
class _MyCardState extends State<MyCard> {
  Color? getStatusColor(String status, {bool forText = false}) {
    switch (status.toLowerCase()) {
      ...
      case 'invoiced':
        return forText
            ? const Color.fromRGBO(3, 111, 173, 1)
            : const Color.fromRGBO(3, 111, 173, 0.2);
      case 'completed':
        return forText
                  ...
                  Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color:
                            getStatusColor(widget.invoiceModel.invoiceStatus),
                      ),
                      height: 20,
                      width: 48,
                      child: Center(
