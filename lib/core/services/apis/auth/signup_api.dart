...
class Api_signup {
  static Future<bool> signupapicall(String firstname, String email,
      String password, String companyname, BuildContext context) async {
    var signupuserdata = {
      "full_name": firstname,
      "email": email,
      "password": password,
    ...
    final response =
        await apiClient.post(Api_Constants.signupurl, signupuserdata);
