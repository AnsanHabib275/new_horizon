...
import 'package:new_horizon/core/models/Alldoctors.dart';
import 'package:new_horizon/core/services/apis/user/getalldoctors.dart';
...
class _LocatorState extends State<Locator> {
  ...
  void filterSearchResults(String query) {
    if (query.isEmpty) {
      ...
      filteredPatientsList = doctorsList?.where((doctors) {
        return doctors.clinic_name.toLowerCase().contains(query.toLowerCase());
      }).toList();
    }
    setState(() {});
  }
                    ...
                    Row(
                      children: [
                        ClipRRect(
                          ...
                          child: Image.network(imageUrls.toString(),
                            ...
                            return Container(
                              ...
                              height: heights <= 690 && widths <= 430 ? 60 : 90,
                              child: const Center(
                                  child: Text(
                                'Not Found',
                                style: TextStyle(
