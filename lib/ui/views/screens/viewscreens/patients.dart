// ignore_for_file: use_key_in_widget_constructors, non_constant_identifier_names, prefer_interpolation_to_compose_strings, prefer_const_constructors, use_build_context_synchronously, deprecated_member_use

import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:get/get.dart';
import 'package:new_horizon/core/constants/asset_constants.dart';
import 'package:new_horizon/core/models/patientdetails.dart';
import 'package:new_horizon/core/services/apis/user/benefitverificationdetailsapi.dart';
import 'package:new_horizon/ui/utils/colors.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/allpatients.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/datasubmission2.dart';
import 'package:new_horizon/ui/views/screens/viewscreens/details.dart';
  ...
  Future<void> loadPatients() async {
    try {
      ...
      var verifiedPatients = fetchedPatients
          .where((patient) => patient.status == 'VERIFIED')
          .toList();
      setState(() {
      ...
      child: MediaQuery(
        ...
        child: Scaffold(
          ...
          body: Column(children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PatientsPending()));
                    },
                    child: Padding(
                      padding: const EdgeInsets.only(bottom: 8.0),
                      child: Text('  Pending',
                  ...
                  GestureDetector(
                    onTap: () async {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PatientsRejected()));
                    },
                    child: Padding(
                      padding: const EdgeInsets.only(bottom: 8.0),
                      child: Text('  Rejected',
            ...
            //       future:
            //           Getbenefitsverificationdetails.GetBenefitDetails(context),
            ...
            //                 valid_until: patientsdata.validTill,
